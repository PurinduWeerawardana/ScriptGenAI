        ...
        <div className="home">
            ...
            <div className="header grid gap-3 grid-rows-60 w-4/6 sm:w-2/3 my-10 m-auto	">
                ...
                <h1 className="text-center m-2 text-lg text-indigo-900">
                    ...
                    <br />
                    <br />
                    <font size ="6"><u><b>Our Team</b></u></font>
                    <br />
                    ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
                    <div class="person-rajani">
                        <img src = "Images/Rajani1.png" alt="" class = "person-pic-rajani"></img>
                    </div>
                    <div class="person-info-rajani">
                        <h2>
                            <b><b>Rajani Randari</b></b>
                        </h2>
                        <p>
                            <b><b>20210190 / w1867050</b></b>
                        </p>
                    </div>

                    <div class="person-purindu">
                        <img src = "Images/Purindu1.png" alt="" class = "person-pic-purindu"></img>
                    </div>
                    <div class="person-info-purindu">
                        <h2>
                            <b><b>Purindu Thamash</b></b>
                        </h2>
                        <p>
                            <b><b>20210379 / w1867462</b></b>
                        </p>
                    </div>

                    <div class="person-lakshan">
                        <img src = "Images/Lakshan1.png" alt="" class = "person-pic-lakshan"></img>
                    </div>
                    <div class="person-info-lakshan">
                        <h2>
                            <b><b>Lakshan Costa</b></b>
                        </h2>
                        <p>
                            <b><b>20210418 / w1867568</b></b>
                        </p>
                    </div>

                    <div class="person-jairamanan">
                        <img src = "Images/Jairamanan1.png" alt="" class = "person-pic-jairamanan"></img>
                    </div>
                    <div class="person-info-jairamanan">
                        <h2>
                            <b><b>Jaiyramanan Vijayaalayan</b></b>
                        </h2>
                        <p>
                            <b><b>20200276 / w1868420</b></b>
                        </p>
                    </div>

                    <div class="person-shiwarne">
                        <img src = "Images/Shiwarne2.png" alt="" class = "person-pic-shiwarne"></img>
                    </div>
                    <div class="person-info-shiwarne">
                        <h2>
                            <b><b>Shiwarne Silva</b></b>
                        </h2>
                        <p>
                            <b><b>20210059 / w1914619</b></b>
                        </p>
                    </div>
